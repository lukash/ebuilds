...
PV_MAJOR_MINOR=$(get_version_component_range 1-2 ${PV})
SRC_URI="https://swdl.bluejeans.com/desktop/linux/${PV_MAJOR_MINOR}/${PV}/bluejeans-${PV}.x86_64.rpm"
...
src_install() {
  ...
  gdosym /opt/${PN}/${PN}-bin /opt/bin/${PN}-bin
  dosym /usr/lib/libgudev-1.0.so /opt/${PN}/libudev.so.0
